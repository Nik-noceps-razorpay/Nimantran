                    ...
                    <div class="card-body">
                        <form method="POST" action="/event">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="details" type="string" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="location" type="string" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="datetime" type="dateTime-local" class="form-control" name="Date and Time">
                                </div>
                            </div>
